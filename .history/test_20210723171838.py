...
class Sort:
    ...
    def partition(self,arr,leftBound,rightBound):
        ran_pivot = random.randint(leftBound,rightBound)
        arr[ran_pivot],arr[rightBound] = arr[rightBound],arr[ran_pivot]
...
arr = random.choices(range(4),k=10)

new_arr =  Solution().countSort(arr)